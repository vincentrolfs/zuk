...
<?php require("addMaps.js.php"); ?>

// Load some files
Q.load("persons.png, dp_persons.png, tileset.png, the_tileset.png, interior.png, bump.mp3, item_found.mp3", function() {

	// Define tilesheet named "persons_sheet"
	Q.sheet("persons_sheet",
			"persons.png",
			{
				tilew: 16,
				tileh: 32
	...
	Q.animations("persons_anim", {
	
		stand_up0: { frames: [1], loop: false },
		stand_down0: { frames: [7], loop: false },
		stand_right0: { frames: [4], loop: false },
		stand_left0: { frames: [10], loop: false },

		walk_up0: { frames: [0, 1, 2], rate: 1/3 },
		walk_down0: { frames: [6, 7, 8], rate: 1/3 },
		walk_right0: { frames: [3, 4, 5], rate: 1/3 },
		walk_left0: { frames: [9, 10, 11], rate: 1/3 },
		
		stand_up1: { frames: [36], loop: false },
		stand_down1: { frames: [42], loop: false },
		stand_right1: { frames: [39], loop: false },
		stand_left1: { frames: [45], loop: false },

		walk_up1: { frames: [35, 36, 37], rate: 1/3 },
		walk_down1: { frames: [41, 42, 43], rate: 1/3 },
		walk_right1: { frames: [38, 39, 40], rate: 1/3 },
		walk_left1: { frames: [44, 45, 46], rate: 1/3 },
		
		stand_up2: { frames: [47], loop: false },
        stand_down2: { frames: [53], loop: false },
        stand_right3: { frames: [50], loop: false },
        stand_left2: { frames: [56], loop: false },

        walk_up2: { frames: [46, 47, 48], rate: 1/3 },
        walk_down2: { frames: [52, 53, 54], rate: 1/3 },
        walk_right2: { frames: [49, 50, 51], rate: 1/3 },
        walk_left2: { frames: [55, 56, 57], rate: 1/3 }
